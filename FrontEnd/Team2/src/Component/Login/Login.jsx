...
function Login() {
    ...
    return (
        ...
        <div className='Contain'>
            <form onSubmit={submitForm} className="login100-form validate-form mt-5">
                <div className="text-center">
                    <img src="#" className="App-logo" alt="logo"/>
                    <span className="login100-form-title pb-1 mt-2 heading"> E learning platform </span>
                    <span className="login100-form-title pb-1 heading"> Account Login </span>
                </div>
